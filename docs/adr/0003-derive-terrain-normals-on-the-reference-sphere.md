...
- **Rebuilding `û` from the quantized texel** was rejected because it would facet lighting to the elevation grid twice; color lookup already uses interpolated globe location and then nearest-neighbor sampling.
