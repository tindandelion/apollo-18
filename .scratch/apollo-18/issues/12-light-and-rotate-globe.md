...
- Object-space globe location still drives lunar color-map lookup. A copy rotated into world space is interpolated and normalized per fragment to become the smooth lighting normal.
...
- [x] The smooth globe uses normalized interpolated globe location as its per-fragment lighting normal.
...
- [x] Focused tests cover globe-location lighting, Lambertian limits, sRGB round trips, and time-to-rotation mapping.
