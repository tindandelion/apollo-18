...
- Vertex-color and lunar-map triangles use two explicit internal rasterization paths that share coverage, culling, and depth behavior. The retained triangle and cube milestones continue to use vertex colors; no general shader abstraction is introduced.
