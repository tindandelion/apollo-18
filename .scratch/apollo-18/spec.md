...
- Hourly latitude values are interpolated linearly. Longitude and lunar position angle are interpolated along their shortest angular paths across wrap boundaries. Framebuffer up represents celestial north; a positive lunar position angle moves the projected north-pole axis counterclockwise from up toward framebuffer left.
